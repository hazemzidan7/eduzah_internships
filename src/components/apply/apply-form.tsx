...
export function ApplyForm() {
  ...
  return (
    <div className="min-h-screen" style={{ background: "#F8F7FF" }} ref={topRef}>
      ...
      {/* Header */}
      <header className="relative overflow-hidden" style={{ minHeight: 360 }}>
        ...
        {/* Overlay: dark only on the left behind text, transparent on the right */}
        <div style={{
          position: "absolute", inset: 0,
          background: "linear-gradient(to right, rgba(50,29,61,0.88) 0%, rgba(50,29,61,0.60) 35%, rgba(50,29,61,0.15) 65%, rgba(50,29,61,0.05) 100%)",
        }} />

        {/* Content */}
        <div className="relative z-10" style={{ padding: "40px 40px 40px 32px", maxWidth: 480 }}>
          ...
          <p className="text-sm" style={{ color: "rgba(255,255,255,0.80)", lineHeight: 1.6, marginBottom: 16 }}>
